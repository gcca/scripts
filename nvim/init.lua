...
require("lazy").setup({
    ...
    spec = {
        ...
        --: {{{ Treesitter
        {
            ...
            build = ":TSUpdate",
            event = "BufReadPre",
            -- Parsers to install manually: :TSInstall c cpp cmake lua python fish bash diff swift javascript typescript html css
        },
        --: }}} Treesitter
        --: {{{ Aerial
        {
        ...
        --: {{{ Mason
        {
            ...
            event = "VeryLazy",
            opts = {
                ensure_installed = { "lua_ls", "pyright", "clangd", "jsonls", "taplo" },
            },
            dependencies = {

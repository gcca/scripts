...
def PathToPythonUsedDuringBuild():
  ...
  if 'VIRTUAL_ENV' in os.environ:
    return p.join(os.environ['VIRTUAL_ENV'], 'bin/python')
  try:
...
def Settings( **kwargs ):
  ...
  if language == 'typescript':
    return {
      'flags': ['--tsserver-binary-path=/home/gcca/crd/thani/back/node_modules/.bin/tsserver'],
      # 'flags': ['--esModuleInterop'],
      # 'ls': {
        # 'typescript': ['sa-o', 'esModuleInterop'],
      # }
    }

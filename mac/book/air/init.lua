...
require("lazy").setup({
    spec = {
        ...
        --: {{{ Navic
        {
            ...
            -- ~/.local/share/nvim/lazy/nvim-navic/lua/nvim-navic/init.lua:233=add_hl
            -- comment línea final: [[.. "%*"]]
            -- error al final del lsp nav con bloque de otro color
            -- o modificar para que sólo se agregue en los navs intermedios obviando el final
...
--         vim.o.numberwidth = 5
--         vim.o.statuscolumn = '%l %C %s '
--     elseif columns < 155 then
--         vim.o.foldcolumn = '5'
--         vim.o.signcolumn = 'yes:7'
--         vim.o.numberwidth = 5
--         vim.o.statuscolumn = '  %l %C %s   '
--     elseif columns < 167 then
--         vim.o.foldcolumn = '6'
...
--: {{{ uración de backup, swap y undo
vim.o.backupdir = '/Users/gcca/Shm/backup/'
vim.o.directory = '/Users/gcca/Shm/swap/'
vim.o.undodir = '/Users/gcca/Shm/undo/'
vim.o.backup = true
vim.o.swapfile = true
vim.o.undofile = true
--: }}} uración de backup, swap y undo
...
-- uraciones de expresión regular y coincidencia
vim.o.magic = true
vim.o.showmatch = true

-- uraciones de tabulación e indentación
...
vim.keymap.set('i', '<C-g>', '<Esc>:w!<CR>', copts)
vim.keymap.set('n', '<C-g>', ':w!<CR>', copts)
...
vim.keymap.set('n', '<C-p>', "<cmd>lua require('telescope.builtin').find_files()<CR>", copts)
...
if vim.loop.os_uname().sysname == 'Darwin' then
    ...
    vim.keymap.set('n', 'π', "<cmd>lua require('telescope.builtin').find_files()<CR>")
end
--: }}} Keymaps

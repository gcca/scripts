if status is-interactive
    ...
    if test (uname) = Darwin
        if test -x $K/Users/hb/bin/brew
            eval ($K/Users/hb/bin/brew shellenv)
        else
    ...
    set -gx FZF_CTRL_T_COMMAND 'fd --type f --hidden --follow --exclude .git --exclude node_modules --exclude dist --exclude .cache'
